  ...
  return (
    <div className="grid min-h-screen place-items-center bg-slate-100 px-4">
      <form onSubmit={submit} className="w-full max-w-md rounded-lg bg-white p-6 shadow-sm">
        <h1 className="text-2xl font-bold">BPS Event Management Portal</h1>
        <p className="mt-1 text-sm text-slate-500">Use the account credentials or access code provided by Boss/Admin.</p>
